...
<head>
    ...
    <title>Criar Tópico | Fyn1x Forum</title>
    ...
    <div class="lg:ml-64 min-h-screen">
        <header class="sticky top-0 z-30 h-16 glass-card flex items-center justify-between px-6 border-b border-slate-800">
            <div class="flex items-center space-x-4">
                <a href="/topics" class="p-2 hover:bg-slate-800 rounded-xl transition">
                    <i data-lucide="arrow-left" class="w-5 h-5"></i>
                </a>
                <h2 class="text-lg font-bold text-white">Criar Tópico</h2>
            </div>
        </header>
                    ...
                    <form action="{{ route('topics.store') }}" method="POST" class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="title" id="title" required
                                ...
                                placeholder="Ex: Como otimizar queries no Laravel?">
                        </div>

                        <div class="space-y-2">
                            <label for="content" class="text-sm font-bold text-slate-400 uppercase tracking-wider">Conteúdo</label>
                            <textarea name="content" id="content" rows="10" required
                                ...
                                placeholder="Descreva seu tópico em detalhes... (Markdown suportado)"></textarea>
                            <p class="text-xs text-slate-500">Markdown suportado</p>
                        </div>

                        <div class="flex items-center justify-end space-x-4 pt-4">
                            <a href="/topics" class="text-slate-400 hover:text-white font-medium transition">
                                Cancelar
                            </a>
